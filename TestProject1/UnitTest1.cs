...
/*        Team107LibraryContext MakeTinyDB()
        {
            var contextOptions = new DbContextOptionsBuilder<Team107LibraryContext>()
            .UseInMemoryDatabase( "LibraryControllerTest" )
            .ConfigureWarnings( b => b.Ignore( InMemoryEventId.TransactionIgnoredWarning ) )
            .UseApplicationServiceProvider( NewServiceProvider() )
            .Options;

            var db = new Team107LibraryContext(contextOptions);
...
/*        [Fact]
        public void Test1()
        {
            ...
            Team107LibraryContext db = MakeTinyDB();
